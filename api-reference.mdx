...
- **[m decompose](/api/cli/decompose/decompose)** — Typer sub-application for the ``m decompose`` command group.
- **[m eval](/api/cli/eval/eval)** — CLI package for test-based LLM evaluation.
- **[m m](/api/cli/m)** — Entrypoint for the ``m`` command-line tool.
