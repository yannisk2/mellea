---
title: "mellea.formatters.granite.granite3.granite33.output"
sidebarTitle: "mellea.formatters.granite.granite3.granite33.output"
description: "Parser which receives Granite 3.3 model output and returns the constituents of the output."
---
